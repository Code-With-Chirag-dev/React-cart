            ...
            {!showCart ? (
                <div className="product-grid">
                   {plantsArray.map((cat,i)=>(
                    <>
                    <div className="plantname_heading"><h1 className="plant_heading">{cat.category}</h1></div>  
